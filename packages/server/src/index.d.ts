export type { AuthConnection, AuthDb, AuthMagicCode, AuthRateLimit, AuthSession, AuthUser, DeleteSessionWhere, GetUserWhere, MagicCodePurpose, UpsertConnectionInput, UpsertMagicCodeInput, UpsertSessionInput, UpsertUserInput, UserType } from "./core/auth-db.ts";
export type { AdditionalFieldsSchema, AdditionalFieldType, AuthServerOptions, CookieOptions, CorsOptions, EmailOptions, JwtOptions, ProviderCredentials, ProvidersOptions, RateLimitOptions, RateLimitWindow, ResolvedAuthServerOptions, SendCodeContext, SessionOptions, SmsOptions, UserOptions } from "./core/auth-server-options.ts";
export type { AuthCallables, AuthHandlers, AuthServer, AuthSessionResult } from "./core/create-auth-server.ts";
...
export type { LocaleMessages, LocalizationOptions } from "./http/get-error-message.ts";
...
export type { OAuthProvider, ProviderIdentity } from "./oauth/providers/oauth-provider.ts";
