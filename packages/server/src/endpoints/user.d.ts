 ...
 */
export declare const getUser: import("../http/define-endpoint.ts").EndpointDefinition<HeadersInput, {
 ...
 */
export declare const updateUser: import("../http/define-endpoint.ts").EndpointDefinition<UpdateUserInput, {
    user: import("../index.ts").AuthUser;
}>;
 ...
 */
export declare const deleteUser: import("../http/define-endpoint.ts").EndpointDefinition<DeleteUserInput, undefined>;
